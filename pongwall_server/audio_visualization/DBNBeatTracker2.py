...
def main() -> None:
    ...
    # version
    parser.add_argument("--version", action="version", version="DBNBeatTracker.2016")
    # input/output options
    io_arguments(parser, output_suffix=".beats.txt", online=True)
